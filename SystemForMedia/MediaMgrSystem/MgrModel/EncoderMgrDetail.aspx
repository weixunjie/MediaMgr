<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="EncoderMgrDetail.aspx.cs" Inherits="MediaMgrSystem.MgrModel.EncoderMgrDetail" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
        ...
        <section id="groupMgrSection">
            ...
            <div class="form-group" style="margin-bottom: 10px">
                ...
                <asp:Label runat="server" AssociatedControlID="TbName" CssClass="col-md-2 control-label" Width="107px">视频源名称:</asp:Label>
