...
public class StorageHelper {
	...
	public static void setPathAddr(Context context, String path) {
		SharedPreferences sharedPreferences = context.getSharedPreferences(
				"jldremote", Context.MODE_MULTI_PROCESS);
	...
	public static void setIsOneMoreTime(Context context, boolean isSecend) {
		SharedPreferences sharedPreferences = context.getSharedPreferences(
				"jldremoteisAnotherTime", Context.MODE_MULTI_PROCESS);
		Editor editor = sharedPreferences.edit();
	...
	public static String getAuditOutputType(Context context, String def) {
		String add = "";
		SharedPreferences sharedPreferences = context.getSharedPreferences(
				"jldremote", Context.MODE_MULTI_PROCESS);
		add = sharedPreferences.getString("auditOutputType", def);
		return add;
	}

	public static void setAuditOutputType(Context context, String def) {

		SharedPreferences sharedPreferences = context.getSharedPreferences(
				"jldremote", Context.MODE_MULTI_PROCESS);
		Editor editor = sharedPreferences.edit();
		editor.putString("auditOutputType", def);
		editor.commit();
