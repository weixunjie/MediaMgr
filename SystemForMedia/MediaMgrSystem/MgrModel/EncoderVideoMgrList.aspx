<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="EncoderVideoMgrList.aspx.cs" Inherits="MediaMgrSystem.MgrModel.EncoderVideoMgrList" %>
                    ...
                    <asp:GridView ID="dvList" runat="server" AutoGenerateColumns="False" Width="557px" OnRowCommand="dvGroupList_RowCommand">
                        <Columns>
                            ...
                            <asp:BoundField DataField="BaudRate" HeaderText="码率" />
                              ...
                              <asp:BoundField DataField="UdpAddress" HeaderText="UDP地址" />
