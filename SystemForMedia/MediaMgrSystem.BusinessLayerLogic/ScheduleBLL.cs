...
namespace MediaMgrSystem.BusinessLayerLogic
{
    public class ScheduleBLL
    {
        ...
        {
            String sqlStr = "INSERT INTO SCHEDULETASKINFO(SCHEDULEID,SCHEDULETASKSTARTTIME,SCHEDULETASKENDTIME,SCHEDULETASKPROGARMID,SCHEDULETASKPRIORITY,SCHEDULETASKWEEKS,SCHEDULETASKSPECIALDAYS,SCHEDULETASKNAME,SCHEDULETASKSPECIALDAYSTOWEEKS,ISRUNNING) values ('{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}','{8}',0)";
